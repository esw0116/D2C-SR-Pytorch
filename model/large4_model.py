...
class D_Net(nn.Module):
    ...
    def forward(self, x):
        ...
        res1 = self.cand13(res1)
        res1 = res1.reshape(b, c, self.scale*(h-3), self.scale*(w-3))
        res2 = self.cand23(res2)
        res2 = res2.reshape(b, c, self.scale*(h-3), self.scale*(w-3))
        res3 = self.cand33(res3)
        res3 = res3.reshape(b, c, self.scale*(h-3), self.scale*(w-3))
        res4 = self.cand43(res4)
        res4 = res4.reshape(b, c, self.scale*(h-3), self.scale*(w-3))
