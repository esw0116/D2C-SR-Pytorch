...
import random
import cv2
from dataset.dataset_utils import augment
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        input_patch, gt_patch = torch.from_numpy(input_patch), torch.from_numpy(gt_patch)
...
class TestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return input_patch, gt_patch, self.val_list[index].split("\t")[0]
